...
\doctitle{Laboratorio de Electrónica III | 25.24}
\docsubtitle{TPL 4}
...
%SECCIONES
\input{Secciones/0_Introduccion}
\newpage
\input{Secciones/1_LPF_AL.tex}
\newpage
\input{Secciones/2_Filtrado_x_conv.tex}\newpage
\input{Secciones/3_THD.tex}
