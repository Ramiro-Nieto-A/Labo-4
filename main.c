...
// Parámetros del Comb
const float alpha = 0.181818f; // 2/11
const float beta  = 0.818181f; // 9/11
...
void my_app(void)
{
	...
	//Casteo y eliminacion de offset a la entrada
	for (int i = 0; i < BUFFER_SIZE; i++)
	{
		// Convertimos y sacamos el offset de 2048
	    float x_n = (float)adc_in[i] - 2048.0f;

	    // Filtro Comb muestra a muestra
	...
	float THD = V0 == 0? 1.0 : sqrtf(Vt * Vt - V0 * V0)/V0;
